...
import com.ccooy.gameframe.testa.filter.ZipPkmAnimationFilter;
import com.ccooy.gameframe.testa.utils.PermissionUtils;
...
public class Camera2Activity extends BaseActivity implements FrameCallback {
    ...
    protected void onFilterSet(TextureController controller){
        ...
        mAniFilter.setAnimation("assets/testa/etczip/cc.zip");
