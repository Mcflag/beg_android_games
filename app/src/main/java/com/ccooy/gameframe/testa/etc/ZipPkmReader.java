    ...
    public boolean open(){
        ...
        try {
            if(path.startsWith("assets/")){
                ...
                Log.e("cccc",path+" is File exists->"+f.exists());
                mZipStream=new ZipInputStream(new FileInputStream(path));
            }
            return true;
        } catch (IOException e) {
            Log.e("cccc","eee-->"+e.getMessage());
            e.printStackTrace();
            return false;
        }
    }
    ...
    private boolean hasElements(){
        try {
            if(mZipStream!=null){
                ...
                Log.e("cccc","mZip entry null");
            }
        } catch (IOException e) {
            Log.e("cccc","err  dd->"+e.getMessage());
            e.printStackTrace();
        }
        return false;
    }
