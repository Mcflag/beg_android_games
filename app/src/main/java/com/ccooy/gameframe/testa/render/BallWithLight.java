package com.ccooy.gameframe.testa.render;
...
import com.ccooy.gameframe.testa.utils.ShaderUtils;
...
public class BallWithLight extends Shape {
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        mProgram= ShaderUtils.createProgram(mView.getResources(),"testa/vshader/BallWithLight.sh","testa/fshader/BallWithLight.sh");
    }
