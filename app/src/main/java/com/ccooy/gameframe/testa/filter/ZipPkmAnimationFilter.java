...
import com.ccooy.gameframe.testa.etc.ZipPkmReader;
...
public class ZipPkmAnimationFilter extends AFilter {
    ...
    protected void onCreate() {
        createProgramByAssetsFile("testa/shader/pkm_mul.vert","testa/shader/pkm_mul.frag");
        texture=new int[2];
