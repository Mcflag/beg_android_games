package com.ccooy.gameframe.testa.obj;
...
import com.ccooy.gameframe.testa.filter.AFilter;
...
public class ObjFilter2 extends AFilter {
    ...
    protected void onCreate() {
        createProgramByAssetsFile("testa/3dres/obj2.vert","testa/3dres/obj2.frag");
        ...
        if(obj!=null&&obj.mtl!=null){
            try {
                Log.e("obj","texture-->"+"testa/3dres/"+obj.mtl.map_Kd);
                textureId=createTexture(BitmapFactory.decodeStream(mRes.getAssets().open("testa/3dres/"+obj.mtl.map_Kd)));
