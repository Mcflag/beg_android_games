...
import com.ccooy.gameframe.test.framework.DynamicGameObject;
import com.ccooy.gameframe.test.framework.Game;
import com.ccooy.gameframe.test.framework.GameObject;
import com.ccooy.gameframe.test.framework.Input.TouchEvent;
import com.ccooy.gameframe.test.framework.Screen;
import com.ccooy.gameframe.test.framework.SpatialHashGrid;
import com.ccooy.gameframe.test.framework.gl.Camera2D;
import com.ccooy.gameframe.test.framework.gl.SpriteBatcher;
import com.ccooy.gameframe.test.framework.gl.Texture;
import com.ccooy.gameframe.test.framework.gl.TextureRegion;
import com.ccooy.gameframe.test.framework.impl.GLGame;
import com.ccooy.gameframe.test.framework.impl.GLGraphics;
import com.ccooy.gameframe.test.framework.math.OverlapTester;
import com.ccooy.gameframe.test.framework.math.Vector2;
...
public class SpriteBatcherTest extends GLGame {
	...
	class SpriteBatcherScreen extends Screen {
		...
		@Override
		public void resume() {
		    texture = new Texture(((GLGame)game), "basictest/atlas.png");
